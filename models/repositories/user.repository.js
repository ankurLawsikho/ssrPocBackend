...
const UsersRepository = {
  ...
  */
    GetByParameter: async (findQry) => {
      try {
        let Info = await User.find(findQry).exec();
        return Info;
      } catch (e) {
        throw e;
      }
   ...
   GetById: async (Id) => {
      try {
        let Info = await User.findOne({ '_id': Id }).exec();
        return Info;
      } catch (e) {
        throw e;
      }
    ...
    */
     deleteInfo: async (findQry) => {
      try {
        let Info = await User.deleteOne(findQry).exec();
        return Info;
      } catch (e) {
        throw e;
      }
    ...
    */
    ...
    try {
      let UpdateInfo = await User.updateMany(parameter, Details).exec();
      return UpdateInfo;
      } catch (error) {
        throw error;
      }
   ...
   UpdateInfo: async (Id, Details) => {
    try {
      let UpdateInfo = await User.updateOne({ _id: Id }, Details).exec();
      return UpdateInfo;
      } catch (error) {
        throw error;
      }
    ...
    */
     fetchUserWithPagination: async (page, limit, roleId, parent) => {
      try {
        ...
        let UserInfo = await User.aggregate(aggrQuery).exec();
        return UserInfo;
      } catch (e) {
        throw e;
      }
